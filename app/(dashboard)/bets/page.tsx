                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div className="space-y-1">
                        ...
                        <div className="text-xs font-semibold text-gray-500 dark:text-gray-400 space-y-0.5">
                          <div>Stake: <span className="text-gray-900 dark:text-white font-bold">{bet.amount}</span> • Deadline: <span className="text-gray-900 dark:text-white font-bold">{new Date(bet.deadline).toLocaleString([], { month: 'short', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</span></div>
