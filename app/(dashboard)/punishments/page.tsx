...
const DEFAULT_PUNISHMENTS = [
  ...
  { place: 3, title: "Third Place", reward: "Cash prize of $50" },
  ...
  { place: 8, title: "Eighth Place", reward: "Before week 1, predict all 8 playoff teams, the league champion, and the last-placed finisher. At season’s end, record a 30-second video for each incorrect prediction explaining why you were wrong and giving credit to the team that proved you wrong." },
